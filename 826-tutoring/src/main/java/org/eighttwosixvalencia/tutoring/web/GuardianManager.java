...
import org.eighttwosixvalencia.tutoring.ejb.AdminBean;
...
public class GuardianManager implements Serializable {
    ...
    private static final Logger logger = Logger.getLogger("org.eighttwosixvalencia.tutoring.web.GuardianManager");
    @EJB
