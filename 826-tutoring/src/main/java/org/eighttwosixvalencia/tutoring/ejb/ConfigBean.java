...
import org.eighttwosixvalencia.tutoring.entity.Administrator;
...
public class ConfigBean {
    ...
    private static final Logger logger = Logger.getLogger("org.eighttwosixvalencia.tutoring.ejb.ConfigBean");
    ...
    public void init() {
        ...
        while (i.hasNext()) {
            ...
            logger.log(Level.INFO, "{0} is: {1}", new Object[]{inStudent.getName(), inStudent.getStatus()});
        }
        ...
        while (j.hasNext()) {
            ...
            logger.log(Level.INFO, "{0} is: {1}", new Object[]{outStudent.getName(), outStudent.getStatus()});
        }
